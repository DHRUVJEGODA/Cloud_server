...
function App() {
  ...
  const testimonials = [
    ...
    {
      quote:
        '“Fast, reliable, and the team is very supportive — helped us scale without downtime.”',
      rating: 5,
      name: 'Anita Roy',
    ...
    {
      quote:
        '“Excellent performance and monitoring — our incidents reduced drastically.”',
      rating: 5,
      name: 'Rahul Verma',
      role: 'Ops Lead',
    },
    {
      quote:
        '“Great onboarding and continuous support — highly recommend their services.”',
      rating: 4,
      name: 'Priya Singh',
      role: 'CTO',
    },
    {
      quote:
        '“Smooth migrations and excellent uptime. Support team is responsive and skilled.”',
      rating: 5,
      name: 'Karan Patel',
    ...
    {
      quote:
        '“Affordable plans with enterprise-level features — perfect for growing startups.”',
      rating: 4,
      name: 'Meera Iyer',
      role: 'Founder',
    },
    ...
    {
      quote:
        '“Highly skilled team, helped us build a robust CI/CD pipeline and improved deployment frequency.”',
      rating: 5,
      name: 'Anmol Gupta',
    ...
    {
      quote:
        '“Their security audits prevented serious vulnerabilities — excellent expertise and process.”',
      rating: 5,
      name: 'Sana Khan',
  ...
  const prevTestimonial = () => {
    const maxIndex = Math.max(0, testimonials.length - visibleCount);
    setCurrentTestimonial((s) => (s <= 0 ? maxIndex : s - 1));
  };

  // when currentTestimonial changes, scroll the corresponding card into view
  useEffect(() => {
    if (!trackRef.current) return;
    const el = trackRef.current.children[currentTestimonial];
      ...
      <main>
        ...
        <section id="testimonials" className="content-section testimonials-section">
          ...
          <div className="testimonials-slider-wrapper">
            ...
            {/* arrows removed — design uses multi-card slider without arrow controls */}
